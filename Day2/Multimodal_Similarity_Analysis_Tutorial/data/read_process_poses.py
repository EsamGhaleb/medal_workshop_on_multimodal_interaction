...
if __name__ == '__main__':
   # load the keypoints dict
   processed_keypoints_dict, mirrored_keypoints_dict = load_keypoints_dict()
   print('Processed keypoints dict loaded with', len(processed_keypoints_dict), 'pairs.')
   print('Mirrored keypoints dict loaded with', len(mirrored_keypoints_dict), 'pairs.')